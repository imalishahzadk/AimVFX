...
const CustomVideo1 = ({ videoSrc, thumbnailSrc }) => {
  ...
  return (
    <div className="video-player-containerrr">
      ...
      {!isStarted && (
        <div
          ...
          onClick={togglePlay}
        >
          <FaPlay size={48} color="#fff" className="play-icon"/>
        </div>
      )}
...
CustomVideo1.propTypes = {
  videoSrc: PropTypes.string.isRequired,
  thumbnailSrc: PropTypes.string.isRequired,
};

export default CustomVideo1;
