          ...
          {aboutus?.map((item, index) => (
            ...
            >
              <div className="flex flex-col gap-y-3">
                ...
                <div className="mt-2">
                  <Button className="px-8 py-2.5 text-sm font-semibold text-gray-900 bg-white bg-transparent hover:border-cyan-500 border-2 border-white rounded-full focus:outline-none focus:border-white focus:shadow-outline-gray active:bg-gray-700 transition duration-150 ease-in-out uppercase">
                    {item?.button}
                  </Button>
                </div>
              </div>
